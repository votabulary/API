...
class MemberSpec extends FlatSpec with Matchers with BeforeAndAfter {
  ...
  it should "support emails with valid punctuation before the @ symbol" in {
    val m = Member(firstName = "Jason", lastName = "Schmitt", email = "jason.schmitt@gmail.com", precinct = 242, emailReminder = true, smsReminder = true, smsNumber = "5127626443")
    m.email should be ("jason.schmitt@gmail.com")
  }
